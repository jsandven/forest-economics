...
which.min(abs(df$return_35 - df$vol_retur)) # Finds the harvesting age with a 2.5% expected return 
which.min(abs(df$return_45 - df$vol_retur)) # Finds the harvesting age with a 2.5% expected return 
